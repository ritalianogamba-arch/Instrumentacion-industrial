...
LISTA_SENSORES = [SENSOR_TEMP_T2, SENSOR_TEMP_T4, SENSOR_PRESION_T1, SENSOR_PRESION_T2, SENSOR_PRESION_T3, SENSOR_PRESION_T4]
...
LISTA_PIDS = [PID_T2, PID_T4, PID_LAB]
...
LISTA_BOTONES_VIRTUALES = [
    ...
    BTN_PID_T2, BTN_PID_T4, BTN_PID_LAB
]
